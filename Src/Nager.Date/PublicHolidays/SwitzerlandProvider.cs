...
namespace Nager.Date.PublicHolidays
{
    ...
    public class SwitzerlandProvider : IPublicHolidayProvider, ICountyProvider
    {
        ...
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            var easterMonday = this._catholicProvider.WhitMonday("Ostermontag", year, countryCode);
            easterMonday.SetLaunchYear(1642);
            easterMonday.SetCounties("CH-ZH", "CH-BE", "CH-LU", "CH-UR", "CH-SZ", "CH-OW", "CH-NW", "CH-GL", "CH-ZG", "CH-FR", "CH-SO", "CH-BS", "CH-BL", "CH-SH", "CH-AR", "CH-AI", "CH-SG", "CH-GR", "CH-AG", "CH-TG", "CH-TI", "CH-VD", "CH-NE", "CH-GE", "CH-JU");

            var whitMonday = this._catholicProvider.WhitMonday("Pfingstmontag", year, countryCode);
            whitMonday.SetCounties("CH-ZH", "CH-BE", "CH-LU", "CH-UR", "CH-SZ", "CH-OW", "CH-NW", "CH-GL", "CH-ZG", "CH-FR", "CH-SO", "CH-BS", "CH-BL", "CH-SH", "CH-AR", "CH-AI", "CH-SG", "CH-GR", "CH-AG", "CH-TG", "CH-TI", "CH-VD", "CH-NE", "CH-GE", "CH-JU");

            var corpusChristi = this._catholicProvider.CorpusChristi("Fronleichnam", year, countryCode);
            corpusChristi.SetCounties("CH-LU", "CH-UR", "CH-SZ", "CH-OW", "CH-NW", "CH-ZG", "CH-FR", "CH-SO", "CH-BL", "CH-AI", "CH-GR", "CH-AG", "CH-TI", "CH-VS", "CH-NE", "CH-JU");
