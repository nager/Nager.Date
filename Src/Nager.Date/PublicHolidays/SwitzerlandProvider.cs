...
namespace Nager.Date.PublicHolidays
{
    ...
    public class SwitzerlandProvider : IPublicHolidayProvider, ICountyProvider
    {
        ...
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            items.Add(this._catholicProvider.WhitMonday("Pfingstmontag", year, countryCode, new string[] { "CH-ZH", "CH-BE", "CH-LU", "CH-UR", "CH-SZ", "CH-OW", "CH-NW", "CH-GL", "CH-ZG", "CH-FR", "CH-SO", "CH-BS", "CH-BL", "CH-SH", "CH-AR", "CH-AI", "CH-SG", "CH-GR", "CH-AG", "CH-TG", "CH-TI", "CH-VD", "CH-NE", "CH-GE", "CH-JU" }));
