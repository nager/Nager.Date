...
namespace Nager.Date.PublicHolidays
{
    ...
    /// Nigeria
    /// </summary>
    public class NigeriaProvider : IPublicHolidayProvider
    {
        ...
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            items.Add(_catholicProvider.GoodFriday("Good Friday", year, countryCode));
            items.Add(_catholicProvider.EasterMonday("Easter Monday", year, countryCode));
