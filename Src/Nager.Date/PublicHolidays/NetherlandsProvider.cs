...
namespace Nager.Date.PublicHolidays
{
    ...
    public class NetherlandsProvider : IPublicHolidayProvider
    {
        ...
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            items.Add(this._catholicProvider.GoodFriday("Goede Vrijdag", year, countryCode).SetType(PublicHolidayType.Authorities | PublicHolidayType.PublicHoliday | PublicHolidayType.School));
