...
namespace Nager.Date.PublicHolidays
{
    ...
    public class ChileProvider : IPublicHolidayProvider, ICountyProvider
    {
        ...
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            items.Add(new PublicHoliday(year, 9, 17, "Fiestas Patrias	", "National holiday", countryCode));
            ...
            items.Add(new PublicHoliday(year, 10, 11, "Encuentro de Dos Mundos", "Columbus Day", countryCode));
            items.Add(new PublicHoliday(year, 10, 31, "Día Nacional de las Iglesias Evangélicas y Protestantes", "Reformation Day", countryCode));
            items.Add(new PublicHoliday(year, 11, 1, "Día de Todos los Santos", "All Saints", countryCode));
            items.Add(new PublicHoliday(year, 11, 21, "Elecciones presidencial, congresistas y regionales", "Presidential, parliamentary and regional elections", countryCode));
