...
namespace Nager.Date.PublicHolidays
{
    public class UnitedStatesProvider : IPublicHolidayProvider
    {
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            items.Add(new PublicHoliday(year, 1, 1, "New Year's Day", "New Year's Day", countryCode, observed: true));
            ...
            items.Add(new PublicHoliday(year, 7, 4, "Independence Day", "Independence Day", countryCode, observed: true));
            items.Add(new PublicHoliday(firstMondayInSeptember, "Labor Day", "Labor Day", countryCode));
            ...
            items.Add(new PublicHoliday(year, 11, 11, "Veterans Day", "Veterans Day", countryCode, observed: true));
            items.Add(new PublicHoliday(fourthThursdayInNovember, "Thanksgiving Day", "Thanksgiving Day", countryCode, 1863));
            items.Add(new PublicHoliday(year, 12, 25, "Christmas Day", "Christmas Day", countryCode, observed: true));
