...
namespace Nager.Date.HolidayProviders
{
    ...
    /// Singapore
    /// </summary>
    internal class SingaporeProvider : IHolidayProvider
    {
        ...
        private Holiday HariRayaPuasa(int year, CountryCode countryCode)
        {
        ...
        private Holiday VesakDay(int year, CountryCode countryCode)
        {
            var name = "Vesak Day";
        ...
        private Holiday HariRayaHaji(int year, CountryCode countryCode)
        {
        ...
        private Holiday Deepavali(int year, CountryCode countryCode)
        {
            var name = "Deepavali";
        ...
        private Holiday PollingDay(int year, CountryCode countryCode)
        {
            if (year == 2023)
            {
