...
{
    /// <summary>
    /// French Guiana HolidayProvider
    /// </summary>
    internal sealed class FrenchGuianaHolidayProvider : AbstractHolidayProvider
    {
        ...
        public FrenchGuianaHolidayProvider(
            ICatholicProvider catholicProvider) : base(CountryCode.GF)
        {
        ...
        protected override IEnumerable<HolidaySpecification> GetHolidaySpecifications(int year)
        {
            var holidaySpecifications = new List<HolidaySpecification>
            {
                ...
                //new HolidaySpecification
                //{
                //    Id = "CAYENNEFESTIVAL-01",
                //    Date = new DateTime(year, 10, 15),
                //    EnglishName = "Cayenne Festival",
                //    LocalName = "Festival Cayenne",
                //    HolidayTypes = HolidayTypes.Public,
                //},
                new HolidaySpecification
                {
        ...
        public override IEnumerable<string> GetSources()
        {
            return
            [
                "https://en.wikipedia.org/wiki/Public_holidays_in_French_Guiana",
            ];
        }
    }
}
