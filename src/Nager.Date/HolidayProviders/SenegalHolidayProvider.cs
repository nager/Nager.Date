...
{
    /// <summary>
    /// Senegal HolidayProvider
    /// </summary>
    internal sealed class SenegalHolidayProvider : AbstractHolidayProvider
    {
        ...
        public SenegalHolidayProvider(
            ICatholicProvider catholicProvider) : base(CountryCode.SN)
        {
        ...
        protected override IEnumerable<HolidaySpecification> GetHolidaySpecifications(int year)
        {
            ...
            //18 Safar	Grand Magal of Touba	The Grand Magal (pilgrimage) is the most important religious festival of the Senegalese Muslim brotherhood, the Mourides.[2]
