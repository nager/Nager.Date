...
namespace Nager.Date.HolidayProviders
{
    ...
    /// Croatia
    /// </summary>
    internal class CroatiaProvider : IHolidayProvider
    {
        ...
        private Holiday GetIndependenceDay(int year, CountryCode countryCode)
        {
        ...
        private Holiday GetRemembranceDay(int year, CountryCode countryCode)
        {
            if (year >= 2020)
            {
        ...
        private Holiday GetStatehoodDay(int year, CountryCode countryCode)
        {
            if (year >= 2002 && year < 2020)
            {
        ...
        private Holiday GetNationalDay(int year, CountryCode countryCode)
        {
            if (year >= 2020)
            {
