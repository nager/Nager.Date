...
namespace Nager.Date.HolidayProviders
{
    ...
    /// Costa Rica
    /// </summary>
    internal class CostaRicaProvider : IHolidayProvider
    {
        ...
        private Holiday GetJuanSantamariaDay(int year, CountryCode countryCode)
        {
        ...
        private Holiday GetLabourDay(int year, CountryCode countryCode)
        {
        ...
        private Holiday GetAnnexationDay(int year, CountryCode countryCode)
        {
        ...
        private Holiday GetMothersDay(int year, CountryCode countryCode)
        {
        ...
        private Holiday GetIndenpendenceDay(int year, CountryCode countryCode)
        {
        ...
        private Holiday GetArmyAbolitionDay(int year, CountryCode countryCode)
        {
