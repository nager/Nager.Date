...
namespace Nager.Date.PublicHolidays
{
    ...
    public class AustraliaProvider : IPublicHolidayProvider, ICountyProvider
    {
        ...
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            var fourthMondayInSeptember = DateSystem.FindDay(year, Month.September, DayOfWeek.Monday, Occurrence.Fourth);
            ...
            items.Add(new PublicHoliday(fourthMondayInSeptember, "King's Birthday", "King's Birthday", countryCode, null, new string[] { "AUS-WA" }));
