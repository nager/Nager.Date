...
namespace Nager.Date.ArchitectureTest
{
    ...
    {
        private readonly IObjectProvider<Class> _holidayProviders = Classes()
            .That()
        ...
        {
            var rule = Classes().That().Are(this._holidayProviders).Should().BeInternal();
        ...
        {
            var rule = Classes().That().Are(this._holidayProviders).Should().BeSealed();
        ...
        {
            var rule = Classes().That().Are(this._holidayProviders).Should().ResideInNamespace("Nager.Date.HolidayProviders");
