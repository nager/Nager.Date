...
namespace Nager.Date.UnitTest.Countries
{
    ...
    public class RomaniaTest
    {
        ...
        public void TestRomania2017()
        {
            ...
            Assert.AreEqual(new DateTime(year, 4, 16), publicHolidays[3].Date, $"{publicHolidays[4].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 4, 17), publicHolidays[4].Date, $"{publicHolidays[5].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 5, 1), publicHolidays[5].Date, $"{publicHolidays[6].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 6, 1), publicHolidays[6].Date, $"{publicHolidays[7].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 6, 4), publicHolidays[7].Date, $"{publicHolidays[8].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 6, 5), publicHolidays[8].Date, $"{publicHolidays[9].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 8, 15), publicHolidays[9].Date, $"{publicHolidays[10].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 11, 30), publicHolidays[10].Date, $"{publicHolidays[11].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 12, 1), publicHolidays[11].Date, $"{publicHolidays[12].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 12, 25), publicHolidays[12].Date, $"{publicHolidays[13].EnglishName} is wrong");
            Assert.AreEqual(new DateTime(year, 12, 26), publicHolidays[13].Date, $"{publicHolidays[14].EnglishName} is wrong");
        }
