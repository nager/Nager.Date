...
namespace Nager.Date.PublicHolidays
{
    public class SwitzerlandProvider : CatholicBaseProvider
    {
        public override IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            items.Add(new PublicHoliday(year, 5, 1, "Tag der Arbeit", "Labor Day", countryCode, null, new string[] { "CH-ZH", "CH-FR", "CH-SO", "CH-BS", "CH-BL", "CH-SH", "CH-AG", "CH-TG", "CH-TI", "CH-NE", "CH-JU" }));
