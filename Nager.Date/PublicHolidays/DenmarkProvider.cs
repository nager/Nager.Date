...
namespace Nager.Date.PublicHolidays
{
    public class DenmarkProvider : IPublicHolidayProvider
    {
        public IEnumerable<PublicHoliday> Get(DateTime easterSunday, int year)
        {
            ...
            items.Add(new PublicHoliday(25, 12, year, "Juledag / 1. juledag", "Christmas Day", countryCode));
            items.Add(new PublicHoliday(25, 12, year, "2. juledag", "St. Stephen's Day", countryCode));
